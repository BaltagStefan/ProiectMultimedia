    ...
    <>
      ...
      <div className="part-details">
        ...
        <div className="part-detail-copy">
          ...
          <div className="detail-actions"><Link className="button" to="/programari"><CalendarPlus /> Programează montaj</Link><Link className="button secondary" to="/chat"><MessageSquareText /> Chat service</Link></div>
      ...
      <div className="glass-card service-offer"><div><span>SERVICE RECOMANDAT</span><h3>AutoTech Nord</h3><p>Montaj disponibil mâine · 4.8 rating</p></div><strong>Manoperă de la 120 lei</strong><Link className="button small" to="/service-uri/1">Vezi service</Link></div>
    </>
  );
}
